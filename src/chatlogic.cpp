...
ChatLogic::~ChatLogic()
{
    ...
    cout << "chatLogic destruct!\n" ;
    //delete _chatBot;

    // delete all nodes
    //task 3, smart ptr don't need delete
    /*
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot moveChatBot("../images/chatbot.png");
    moveChatBot.SetChatLogicHandle(this);
    // add chatbot to graph root node
    moveChatBot.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(moveChatBot));
    cout << "Move to node done!\n";
    ////
    //// EOF STUDENT CODE
}
...
{
    if(_panelDialog == nullptr || _panelDialog == NULL)
        cout << "warn: _panelDialog is null!\n";
